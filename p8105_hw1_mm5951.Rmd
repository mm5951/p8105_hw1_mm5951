...
Next, with the `ggplot`function, I will plot the variables flipper_length_mm (y) vs bill_length_mm (x), using different color points for each species. First I generate 

```{r}
ggplot(penguins, aes(x = bill_length_mm, y = flipper_length_mm, color = species)) + geom_point()
```

Finally, using the `ggsave`function I will save the scatter plot into the project directory.
